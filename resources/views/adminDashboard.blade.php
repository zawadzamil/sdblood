                        ...
                        <div class="slim-scroll" data-height="auto" data-disable-fade-out="true" data-distance="0" data-size="10px" data-railOpacity="0.2">
                                ...
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu animated fadeInRight m-t-xs">
                                        ...
                                        <li><form method="POST" action="{{ route('logout') }}">
                                                @csrf
                                                <button type="submit" class="w-24 p-2  hover:bg-red-400 rounded-lg">Logout</button>
                                            </form></li>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <nav class="nav-primary hidden-xs batch268">
                                ...
                                <ul class="nav nav-main" data-ride="collapse">
                                    ...
                                    <li class="">
                                        <a href="{{url('add-employee')}}" class="auto"> <i class="i i-statistics icon"> </i> <span class="font-bold">Add New Employee</span> </a>
                                    </li>

                                    <li class="">
                                        <a href="{{url('show-employee')}}" class="auto"> <i class="i i-statistics icon"> </i> <span class="font-bold"> View Employees</span> </a>
                                    </li>

                                    <li class="">
                                        <a href="{{url('donation')}}" class="auto"> <i class="i i-statistics icon"> </i> <span class="font-bold">New Donation</span> </a>
                                    </li>

                                    <li class="">
                                        <a href="{{url('add-transaction')}}" class="auto"> <i class="i i-statistics icon"> </i> <span class="font-bold">New Transaction</span> </a>
                                    </li>

                                    <li class="">
                                        <a href="{{url('all-transaction')}}" class="auto"> <i class="i i-statistics icon"> </i> <span class="font-bold">View All Transaction</span> </a>
                                    </li>
