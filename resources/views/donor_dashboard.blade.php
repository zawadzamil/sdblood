...
<div class="main">
    @php
    if(\App\Models\Donation::where('donor_id',Auth::user()->id)->count()>=1)
    {
         $date = \App\Models\Donation::where('donor_id',Auth::user()->id)->first()->value('date');
    }
    else{
    ...
    @endphp
    <h1 class="title text-4xl font-bold">Donor Information</h1>
    ...
    <div class="division">
        <div class="first shadow-xl p-4 w-11/12 rounded-lg">
            <table>
                ...
                <tr><td></td>
                    <td class="p-2 ml-2 font-bold">Donor Id:</td>
                ...
                <tr>
                    <td></td>
                    <td class="p-2 ml-2 font-bold">Last Donated: </td>
                    <td class="p-4 lg:px-8 ml-8" colspan="3">{{$date}}</td>
                </tr>
            </table>
